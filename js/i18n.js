...
const I18N = {
  en: {
    ...
    sellHint: "This is a frontend-only demo: no images are uploaded, your listing is saved in this browser.",
    cancelBtn: "Cancel",
    ...
    placeholderFullName: "e.g. Abdullah Al-Saud",
    ...
    demoHint: "Demo tip: try demo@motoharaj.sa / demo1234, or create your own account.",
...
fileTooLarge: "File Too Large",
  ...
  ar: {
    ...
    sellSubtitle: "أدخل التفاصيل أدناه. يظهر إعلانك في أعلى الصفحة الرئيسية فوراً.",
    ...
    loginTitle: "تسجيل الدخول إلى بييك.إكس",
    ...
    demoHint: "نصيحة تجريبية: جرّب demo@motoharaj.sa / demo1234، أو أنشئ حسابك الخاص.",
    ...
    googlePickerFootnote: "تجريبي فقط — لا يتم الاتصال بأي حساب جوجل حقيقي.",
    ...
    dashboardTitle: "لوحة التحكم — بييك.إكس",
