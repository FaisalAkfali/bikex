...
// ---------- ALL SAUDI REGIONS & CITIES ----------
const REGIONS = [
  {
    id: 'riyadh',
    nameEn: 'Riyadh',
    nameAr: 'الرياض',
    cities: ['Riyadh', 'Al-Kharj', 'Dawadmi', 'Al-Majma\'ah', 'Al-Zulfi', 'Shaqra', 'Al-Ghat']
  },
  {
    id: 'makkah',
    nameEn: 'Makkah',
    nameAr: 'مكة المكرمة',
    cities: ['Mecca', 'Jeddah', 'Taif', 'Rabigh', 'Al-Lith', 'Khulais']
  },
  {
    id: 'madinah',
    nameEn: 'Madinah',
    nameAr: 'المدينة المنورة',
    cities: ['Medina', 'Yanbu', 'Al-Ula', 'Badr', 'Khaybar']
  },
  {
    id: 'eastern',
    nameEn: 'Eastern Province',
    nameAr: 'المنطقة الشرقية',
    cities: ['Dammam', 'Khobar', 'Dhahran', 'Jubail', 'Hofuf', 'Qatif', 'Ras Tanura', 'Abqaiq']
  },
  {
    id: 'aseer',
    nameEn: 'Aseer',
    nameAr: 'عسير',
    cities: ['Abha', 'Khamis Mushait', 'Bisha', 'Sarat Abidah', 'Rijal Alma']
  },
  {
    id: 'jazan',
    nameEn: 'Jazan',
    nameAr: 'جازان',
    cities: ['Jazan', 'Sabya', 'Abu Arish', 'Samtah']
  },
  {
    id: 'najran',
    nameEn: 'Najran',
    nameAr: 'نجران',
    cities: ['Najran', 'Sharurah', 'Hubuna']
  },
  {
    id: 'albaha',
    nameEn: 'Al-Baha',
    nameAr: 'الباحة',
    cities: ['Al-Baha', 'Baljurashi', 'Al-Makhwah']
  },
  {
    id: 'tabuk',
    nameEn: 'Tabuk',
    nameAr: 'تبوك',
    cities: ['Tabuk', 'Al-Wajh', 'Duba', 'Taima']
  },
  {
    id: 'hail',
    nameEn: 'Hail',
  ...
  },
  {
    ...
    nameEn: 'Al-Jawf',
    nameAr: 'الجوف',
    cities: ['Sakaka', 'Dumat Al-Jundal', 'Qurayyat']
  },
  {
    id: 'qassim',
    nameEn: 'Al-Qassim',
    nameAr: 'القصيم',
    cities: ['Buraidah', 'Unayzah', 'Ar Rass', 'Al-Bukayriyah', 'Al-Muzahimiyah']
  }
];
...
function getRegionForCity(city) {
  return REGIONS.find(r => r.cities.includes(city)) || null;
}
